# React :construction: [WIP]

From: https://github.com/airbnb/javascript/blob/master/react/README.md
...
## Props 属性
  ...
  <div />
  ```
  - 避免使用数组的index来作为属性`key`的值，推荐使用唯一ID。推荐都加上key,优化效率. ([为什么?](https://medium.com/@robinpokorny/index-as-a-key-is-an-anti-pattern-e0349aece318))
